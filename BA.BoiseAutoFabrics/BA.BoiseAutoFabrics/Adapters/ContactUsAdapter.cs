using BA.BoiseAutoFabrics.DataModels;
using BA.BoiseAutoFabrics.Configuration;
...
namespace BA.BoiseAutoFabrics.Adapters
{
    public class ContactUsAdapter
    {
        ...
        private string ReplaceTokens(string body, ContactUsModel contact)
        {
            string _body = body.Replace(@"[Name]", contact.Name)
                ...
                .Replace(@"[DetroitNumber]", contact.DetroitNumber)
